...
public interface Image {
    ...
    /**
     * Allows iterating the subImages by order (first row, second row and so on).
     *
     * @return an Iterable<Image> that can be traversed with a foreach loop
     */
    default Iterable<Image> subImages(int sizeOfImage) {
        return new SubImageIterableProperty<>(this, sizeOfImage,
                (x, y) -> new SubImage(x, y, sizeOfImage, this::getPixel));
    }
}
